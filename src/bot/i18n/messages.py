...
/relay <текст> - Переслать сообщение в админский чат
...
Неизвестные команды будут проигнорированы.
    ...
    "command_deferrals": [
        "Ну мы посмотрим",
        "Не могу обещать что это возможно",
        "Пока хз",
        "Попозже отвечу",
        "Пока не знаю, не в ресурсе",
        "Давай не сегодня",
        "Не вариант, братик",
        "Вернусь к этому вопросу попозже",
        "С оффицерами не общаюсь"
    ],
    ...
    "admin_relay_private_only": "❌ Эту команду можно использовать только в личке с ботом.",
    "admin_relay_usage": "❌ Использование: /relay <текст>",
    ...
    "inline_gpt_title": "🤖 Спросить у Жеки",
    "inline_gpt_error": "❌ Не удалось получить ответ от Жеки. Попробуйте позже.",
}
